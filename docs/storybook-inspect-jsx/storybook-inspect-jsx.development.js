...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("@storybook/addons"));
	else if(typeof define === 'function' && define.amd)
		define("rakutenRexStorybookInspectJsx", ["react", "@storybook/addons"], factory);
	else if(typeof exports === 'object')
		exports["rakutenRexStorybookInspectJsx"] = factory(require("react"), require("@storybook/addons"));
	else
		root["rakutenRexStorybookInspectJsx"] = factory(root["React"], root["StorybookAddons"]);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "withInspectJsx", function() { return withInspectJsx; });
/* harmony import */ var jsx_to_string__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
/* harmony import */ var jsx_to_string__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jsx_to_string__WEBPACK_IMPORTED_MODULE_0__);
...
var withInspectJsx = Object(_storybook_addons__WEBPACK_IMPORTED_MODULE_1__["makeDecorator"])({
  name: 'withInspectJsx',
  skipIfNoParametersOrOptions: false,
  allowDeprecatedUsage: true,
  wrapper: function wrapper(getStory, context) {
    var Story = getStory(context); // eslint-disable-next-line prefer-const

    var jsx = '';

    if (Story.type.toString() === 'Symbol(react.fragment)') {
      if (Array.isArray(Story.props.children)) {
        Array.from(Story.props.children).forEach(function (item) {
          jsx += jsx_to_string__WEBPACK_IMPORTED_MODULE_0___default()(item);
        });
      } else {
        jsx = jsx_to_string__WEBPACK_IMPORTED_MODULE_0___default()(Story.props.children);
      }
    } else {
      jsx = jsx_to_string__WEBPACK_IMPORTED_MODULE_0___default()(Story);
    }
